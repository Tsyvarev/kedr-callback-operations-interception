/*
 * Test different direct interceptors for watch for the same object.
 */
...
KEDR_COI_TEST_DEFINE_PRE_HANDLER_FUNC(op_pre1, op_pre1_call_counter)

static struct kedr_coi_pre_handler pre_handlers[] =
{
    PRE_HANDLER(op, op_pre1),
