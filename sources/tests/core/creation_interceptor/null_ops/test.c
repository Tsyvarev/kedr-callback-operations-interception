/*
 * Test that constructor interceptor works correctly in case of null
...
{
    POST_HANDLER_EXTERNAL(op2, op2_post1),
...
{
    int result;
    const struct test_operations* object_operations = NULL;
    void* id = (void*)0x123;
