/*
 * Test functionality of several factory interceptors with same operations.
 */
...
int test_run(void)
{
    ...
    if(result < 0)
    {
        pr_err("Another factory interceptor failed to watch an object whith same operations.");
