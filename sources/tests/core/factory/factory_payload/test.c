...
KEDR_COI_TEST_DEFINE_HANDLER_FUNC(op1_pre1_factory, op1_pre1_factory_call_counter)

int op1_post1_factory_call_counter;
KEDR_COI_TEST_DEFINE_HANDLER_FUNC(op1_post1_factory, op1_post1_factory_call_counter)


static struct kedr_coi_handler pre_handlers_factory[] =
{
    HANDLER(op1, op1_pre1_factory),
    kedr_coi_handler_end
};

static struct kedr_coi_handler post_handlers_factory[] =
{
    HANDLER(op1, op1_post1_factory),
    kedr_coi_handler_end
};
