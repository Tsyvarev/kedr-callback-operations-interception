/*
 * Test functionality of several foreign interceptors with same operations.
 */
...
int test_run(void)
{
    ...
    if(result < 0)
    {
        pr_err("Another foreign interceptor failed to watch an object whith same operations.");
